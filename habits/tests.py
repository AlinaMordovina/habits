...
class HabitTestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.habit = Habit.objects.create(
            place="test_place", action="test_action", owner=self.user
        )

    def test_create_habit(self):
        url = reverse("habits:habit_create")

        data = {"place": "test_create", "action": "test_create", "owner": self.user.pk}
    ...
    def test_update_habit(self):
        ...
        data = {"place": "place_update", "action": "action_update"}
